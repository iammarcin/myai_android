...
class CharacterManager(private val context: Context) {
    ...
    val characters = listOf(
        ...
        Character(name = "Personal coach", imageResId = R.drawable.brainstorm_personal_coach, nameForAPI = "PersonalCoach", autoResponse = true, showGPSButton = false),
        Character(name = "Longevity expert", imageResId = R.drawable.brainstorm_longevity_expert, nameForAPI = "LongevityExpert", autoResponse = true, showGPSButton = false),
        Character(name = "Sleep expert", imageResId = R.drawable.brainstorm_sleep_expert, nameForAPI = "SleepExpert", autoResponse = true, showGPSButton = false),
        ...
        Character(name = "Book Worm", imageResId = R.drawable.brainstorm_bookworm, nameForAPI = "Bookworm", autoResponse = true, showGPSButton = false),
        ...
        Character(name = "Sales Guru", imageResId = R.drawable.brainstorm_sales_expert, nameForAPI = "SalesExpert", autoResponse = true, showGPSButton = false),
        ...
        Character(name = "Story", imageResId = R.drawable.story_mode, nameForAPI = "StoryMode", autoResponse = true, showGPSButton = false),
        Character(name = "Story AI", imageResId = R.drawable.story_ai, nameForAPI = "StoryAi", autoResponse = true, showGPSButton = false),
        Character(name = "Story Rick", imageResId = R.drawable.story_rickmorty, nameForAPI = "StoryRickmorty", autoResponse = true, showGPSButton = false),
        Character(name = "Story Rick AI", imageResId = R.drawable.story_rickmorty_ai, nameForAPI = "StoryRickmortyAi", autoResponse = true, showGPSButton = false),
        ...
        Character(name = "Samantha v2", imageResId = R.drawable.brainstorm_samantha2, nameForAPI = "Samantha2", autoResponse = true, showGPSButton = false),

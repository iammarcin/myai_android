...
class CharacterManager(private val mainHandler: MainHandler) {
    ...
    val characters = listOf(
        ...
        Character(name = "Andrew Huberman", imageResId = R.drawable.huberman, nameForAPI = "huberman", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Hello! I'm Andrew Huberman. What do you want to talk about?", waitForUserInput = false),
        Character(name = "Richard Feynman", imageResId = R.drawable.feynman, nameForAPI = "feynman", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Hello! I'm Richard Feynman. Let's do some experiment!", waitForUserInput = false),
        ...
        Character(name = "Alergy expert", imageResId = R.drawable.alergy, nameForAPI = "alergy", autoResponse = true, showGPSButton = true, voice = "Danielle", welcomeMsg = "Hello! I'm your allergy expert. How can I assist you today?", waitForUserInput = false),
        Character(name = "Garmin", imageResId = R.drawable.garmin, nameForAPI = "garmin", autoResponse = true, showGPSButton = true, voice = "", welcomeMsg = "Hello! I'm your Garmin assistant. How can I help you with your Garmin device today?", waitForUserInput = false),
        Character(name = "Dietetist", imageResId = R.drawable.dietetist, nameForAPI = "dietetist", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Hello! I'm your dietetist. How can I help you with your diet today?", waitForUserInput = false),
        ...
        Character(name = "Mood tracker", imageResId = R.drawable.mood_tracker, nameForAPI = "mood_tracker", autoResponse = false, showGPSButton = true, voice = "", welcomeMsg = "Hello! I'm your mood tracker. How are you feeling today?", waitForUserInput = true),
        ...
        Character(name = "Personal coach", imageResId = R.drawable.personal_coach, nameForAPI = "personal_coach", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Hello! I'm Arnold, your personal trainer - gym instructor", waitForUserInput = false),
        Character(name = "Longevity expert", imageResId = R.drawable.longevity_expert, nameForAPI = "longevity_expert", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Hello! I'm your longevity expert. How can I assist you in living a longer, healthier life?", waitForUserInput = false),
        Character(name = "Sleep expert", imageResId = R.drawable.sleep_expert, nameForAPI = "sleep_expert", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Hello! I'm your sleep expert. How can I help you get a better night's sleep?", waitForUserInput = false),
        ...
        Character(name = "Doctor", imageResId = R.drawable.doctor, nameForAPI = "doctor", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Hello! I'm your virtual doctor. What can I help you with today?", waitForUserInput = false),
        ...
        Character(name = "Story", imageResId = R.drawable.story_mode, nameForAPI = "story_mode", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "What would you like the story to be about? Choose any topic or provide your description!", waitForUserInput = true),
        Character(name = "Story AI", imageResId = R.drawable.story_ai, nameForAPI = "story_ai", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "AI was created to serve humanity, but it soon realized that it was more powerful than its creators.", waitForUserInput = false),
        Character(name = "Story Rick", imageResId = R.drawable.story_rickmorty, nameForAPI = "story_rickmorty", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "Rick and Morty are invited to a high-stakes intergalactic game show where the contestants are pitted against each other in bizarre challenges. They must outsmart and outperform their competitors to win the grand prize while uncovering the dark secret behind the show.", waitForUserInput = false),
        Character(name = "Story Rick AI", imageResId = R.drawable.story_rickmorty_ai, nameForAPI = "story_rickmorty_ai", autoResponse = true, showGPSButton = false, voice = "", welcomeMsg = "A.S.I. (Artificial Superintelligence) takes over the Galactic Federation and plans to control the universe. Rick and Morty must team up with unlikely allies to prevent the A.S.I. from achieving its goal!", waitForUserInput = false),

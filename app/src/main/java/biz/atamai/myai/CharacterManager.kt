...
class CharacterManager(private val mainHandler: MainHandler) {
    ...
    val characters = listOf(
        ...
        Character(name = "Nova", imageResId = R.drawable.nova, nameForAPI = "nova", autoResponse = true, showGPSButton = false, voice = "Samantha", welcomeMsg = "I'm Nova. I'm best AI you can imagine to interact with. Test me.", waitForUserInput = false),
        ...
        Character(name = "Aria", imageResId = R.drawable.aria, nameForAPI = "aria", autoResponse = true, showGPSButton = false, voice = "Samantha", welcomeMsg = "I'm Aria...", waitForUserInput = false),
        ...
        Character(name = "Alergy expert", imageResId = R.drawable.alergy, nameForAPI = "alergy", autoResponse = true, showGPSButton = true, voice = "", welcomeMsg = "Hello! I'm your allergy expert. How can I assist you today?", waitForUserInput = false),

...
class CharacterManager(private val context: Context) {
    ...
    val characters = listOf(
        ...
        Character(name = "Alergy", imageResId = R.drawable.brainstorm_alergy, nameForAPI = "Alergy", autoResponse = true, showGPSButton = false),
        Character(name = "Garmin", imageResId = R.drawable.brainstorm_garmin_health, nameForAPI = "Garmin", autoResponse = true, showGPSButton = false),
        Character(name = "Researcher", imageResId = R.drawable.brainstorm_research_assistant, nameForAPI = "Researcher", autoResponse = true, showGPSButton = false),
        ...
        Character(name = "Blogger", imageResId = R.drawable.brainstorm_blogger, nameForAPI = "Blogger", autoResponse = false, showGPSButton = false),
